...
describe("selection-handler kit access logic", () => {
	...
	describe("error messages", () => {
		it("generates correct error for no access", () => {
			const errorMessage = "No Pankit access found.";
			const helpMessage = "Purchase at https://pankit.cc";

			expect(errorMessage).toBe("No Pankit access found.");
			expect(helpMessage).toContain("pankit.cc");
		});
